<?php
        ...
        $result = update_account_manager($user_id);
        if ($result) {
            success_response(0, "Cập nhật chức vụ trưởng phòng thành công");
        } else {
            error_response(5, "Cập nhật chức vụ trưởng phòng thất bại");
        }
?>