...
<div>
					...
					<div class="scrollable-task">
						...
						<div class="e__task__infomation">
							<?php
								...
								$sql = "SELECT * FROM NHIEMVU WHERE trangThai = 'new' ORDER BY hanThucHien";
								...
								while ($row = $result->fetch_assoc()) {
									...
									// data-toggle='modal' data-target='#file-info-dialog'

									echo	"<div class='d-flex task-list'>
												<div class='task-name__heading col-xl-2 col-lg-4 col-md-3 col-sm-12 col-12 border border-top-0 border-left-0'>
													<p class='task-name  mb-0 p-1'><a href='task_infomation.php?id=$id'>$name</a></p>
												</div>
												<div class='task-description__heading col-xl-6 col-lg-4 col-md-7 border border-top-0 border-left-0'>
    ...
    <script>
		...
		// const updateInProgressTask = 'http://localhost:8080/employee/update_inprogress_task.php';

		// function updateInProgressTask(e) {
		// 	e.preventDefault();
		...
		function moveToGetInProgressTask() {
			...
			let conditionTask = document.querySelector('.employee__task-rate');
			...
			fetch(updateInProgressTask,
			
			
			)
			conditionTask.innerHTML = 'inprogress';
		}
    </script>
