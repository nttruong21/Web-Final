...
<head>
    ...
    <title>Danh sách nhiệm vụ bị trả về</title>
	...
	<div>
		<div class="row m-0">
            ...
            <div class="col-xl-10 col-lg-10 col-md-10 col-sm-10 col-10 rounded border border-left-0 border-right-0 border-bottom-0">
				<div class="all-task border border-left-0 border-right-0">
					<div class="task-content scrollable">
						...
						<div class="e__task__infomation">
							<?php
								...
								$sql = "SELECT * FROM NhiemVu WHERE trangThai = 'rejected' ORDER BY hanThucHien";
								...
								$sqll = 'SELECT * FROM NhiemVuHoanThanh, NhiemVu WHERE NhiemVuHoanThanh.maNhiemVu = NhiemVu.maNhiemVu';
